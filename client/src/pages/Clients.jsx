                ...
                <div>
                    ...
                    <nav>
                        <ul className="space-y-3">
                            ...
                            <li><a href="/quotations" className="block py-2 px-4 rounded hover:bg-gray-700 transition">Quotations</a></li>
                            <li><a href="/clients" className="block py-2 px-4 rounded bg-gray-700 font-semibold">Clients</a></li>
                            <li><a href="/materials" className="block py-2 px-4 rounded hover:bg-gray-700 transition">Materials</a></li>
                        </ul>
                    </nav>
                </div>
                <div><a href="/signin" onClick={() => localStorage.removeItem('token')} className="block py-2 px-4 rounded hover:bg-red-700 bg-red-600 text-center transition">Logout</a></div>
            </aside>
