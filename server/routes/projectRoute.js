...
router.get("/projects/by-quotation/:quotationId", authMiddleware, asyncHandler(async (req, res) => {
...
router.post("/projects", authMiddleware, rules.createProject, validate, asyncHandler(async (req, res) => {
...
router.get("/projects/:id", authMiddleware, rules.idParam, validate, asyncHandler(async (req, res) => {
    const { id } = req.params;
...
router.post("/projects/:id/tasks", authMiddleware, rules.idParam, asyncHandler(async (req, res) => {
...
router.post("/projects/:id/expenses", authMiddleware, rules.idParam, upload.single('receipt'), asyncHandler(async (req, res) => {
    const { id: project_id } = req.params;
...
router.post("/projects/:id/notes", authMiddleware, rules.idParam, asyncHandler(async (req, res) => {
    const { id: project_id } = req.params;
    const { note } = req.body;
...
router.post("/projects/:id/files", authMiddleware, rules.idParam, upload.single('file'), asyncHandler(async (req, res) => {
    const { id: project_id } = req.params;
    const { file } = req;
...
router.delete("/files/:fileId", authMiddleware, asyncHandler(async (req, res) => {
...
router.put("/tasks/:id", authMiddleware, rules.idParam, asyncHandler(async (req, res) => {
    const { id } = req.params;
...
router.put("/projects/:id/status", authMiddleware, rules.idParam, asyncHandler(async (req, res) => {
    const { id } = req.params;
    const { status } = req.body;
